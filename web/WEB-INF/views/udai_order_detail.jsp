		...
		<section class="user-center inner clearfix">
			...
			<div class="pull-right">
				<div class="user-content__box clearfix bgf">
					<div class="title">订单中心-订单 ${requestScope.orderDetail.ORDERS_ID}</div>
					<div class="order-info__box">
						...
						<div class="order-info">
							...
							<table>
								<tr>
									<td>订单编号：${requestScope.orderDetail.ORDERS_ID}</td>
						...
						<div class="order-item__list">
							<c:forEach items="${requestScope.orderDetail.products}" var="product">
								<div class="item">
									...
									<div class="tdf2">
										<div class="ep2">活动${product.DISCOUNT * 10}折优惠<%--<br>优惠：¥4.0--%></div>
									</div>
