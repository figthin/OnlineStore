		...
		<section class="item-show__div item-show__head clearfix">
			<div class="pull-left">
				...
				<div class="item-pic__box" id="magnifier">
					<div class="small-box">
						<img class="cover" src="${path}/${requestScope.product.URL}" alt="${requestScope.product.NAME}">
					...
					<%--<div class="thumbnail-box">
						...
						<div class="thumb-list">
							<ul class="wrapper clearfix">
								<li class="item active" data-src="${path}/static/images/temp/S-001-1_b.jpg"><img class="cover" src="${path}/static/images/temp/S-001-1_s.jpg" alt="商品预览图"></li>
								<li class="item" data-src="${path}/static/images/temp/S-001-2_b.jpg"><img class="cover" src="${path}/static/images/temp/S-001-2_s.jpg" alt="商品预览图"></li>
								<li class="item" data-src="${path}/static/images/temp/S-001-3_b.jpg"><img class="cover" src="${path}/static/images/temp/S-001-3_s.jpg" alt="商品预览图"></li>
								<li class="item" data-src="${path}/static/images/temp/S-001-4_b.jpg"><img class="cover" src="${path}/static/images/temp/S-001-4_s.jpg" alt="商品预览图"></li>
								<li class="item" data-src="${path}/static/images/temp/S-001-5_b.jpg"><img class="cover" src="${path}/static/images/temp/S-001-5_s.jpg" alt="商品预览图"></li>
								<li class="item" data-src="${path}/static/images/temp/S-001-6_b.jpg"><img class="cover" src="${path}/static/images/temp/S-001-6_s.jpg" alt="商品预览图"></li>
								<li class="item" data-src="${path}/static/images/temp/S-001-7_b.jpg"><img class="cover" src="${path}/static/images/temp/S-001-7_s.jpg" alt="商品预览图"></li>
								<li class="item" data-src="${path}/static/images/temp/S-001-8_b.jpg"><img class="cover" src="${path}/static/images/temp/S-001-8_s.jpg" alt="商品预览图"></li>
								<li class="item" data-src="${path}/static/images/temp/S-001-9_b.jpg"><img class="cover" src="${path}/static/images/temp/S-001-9_s.jpg" alt="商品预览图"></li>
								<li class="item" data-src="${path}/static/images/temp/S-001-10_b.jpg"><img class="cover" src="${path}/static/images/temp/S-001-10_s.jpg" alt="商品预览图"></li>
							</ul>
						</div>
				...
				<div class="item-info__box">
					<div class="item-title">
						<div class="name ep2">${requestScope.product.NAME}</div>
					...
					<ul class="item-ind-panel clearfix">
						<li class="item-ind-item">
							...
							<span class="ind-count cr">${requestScope.product.SALE}</span>
						</li>
						<li class="item-ind-item">
							<a href=""><span class="ind-label c9">累计评论</span>
							<span class="ind-count cr">${requestScope.evaluations.size()}</span></a>
						</li>
						<li class="item-ind-item">
							<a href=""><span class="ind-label c9">赠送积分</span>
							<span class="ind-count cg">${requestScope.product.POINTS}</span></a>
						</li>
					</ul>
					<div class="item-key">
						<div class="item-sku">
				...
				<div class="swiper-container picked-swiper">
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							...
							<a class="picked-item" href="">
								<img src="${path}/static/images/temp/S-001-6_s.jpg" alt="" class="cover">
								<div class="look_price">¥134.99</div>
							</a>
						</div>
						<div class="swiper-slide">
							<a class="picked-item" href="">
								<img src="${path}/static/images/temp/S-001-7_s.jpg" alt="" class="cover">
								<div class="look_price">¥134.99</div>
							</a>
							<a class="picked-item" href="">
								<img src="${path}/static/images/temp/S-001-8_s.jpg" alt="" class="cover">
								<div class="look_price">¥134.99</div>
							</a>
							<a class="picked-item" href="">
								<img src="${path}/static/images/temp/S-001-9_s.jpg" alt="" class="cover">
								<div class="look_price">¥134.99</div>
							</a>
						</div>
						<div class="swiper-slide">
							<a class="picked-item" href="">
								<img src="${path}/static/images/temp/S-001-10_s.jpg" alt="" class="cover">
								<div class="look_price">¥134.99</div>
							</a>
							<a class="picked-item" href="">
								<img src="${path}/static/images/temp/S-001-1_s.jpg" alt="" class="cover">
		...
		<section class="item-show__div item-show__body posr clearfix">
			<div class="item-nav-tabs">
				<ul class="nav-tabs nav-pills clearfix" role="tablist" id="item-tabs">
					...
					<li role="presentation"><a href="#evaluate" role="tab" data-toggle="tab" aria-controls="evaluate">累计评价 <span class="badge">${requestScope.evaluations.size()}</span></a></li>
				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane fade in active" id="detail" aria-labelledby="detail-tab">
						<div class="item-detail__info clearfix">
							<div class="record">商品编号：${requestScope.product.PRODUCT_ID}</div>
							<div class="record">上架时间：${requestScope.product.ADD_TIME}</div>
							<div class="record">商品毛重：${requestScope.product.WEIGHT}</div>
							<div class="record">商品库存：${requestScope.product.STOCK}</div>
						</div>
						<div class="rich-text">
							<p style="text-align: center;">
								<i id="desc-module-1" style="font-size: 0"></i>

								<img src="${path}/static/images/temp/S-001_1.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_2.jpg" alt=""><br>

								<i id="desc-module-2" style="font-size: 0"></i><img src="${path}/static/images/temp/S-001_3.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_4.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_5.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_6.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_7.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_8.jpg" alt=""><br>
								
								<i id="desc-module-3" style="font-size: 0"></i><img src="${path}/static/images/temp/S-001_9.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_10.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_11.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_12.jpg" alt=""><br>
								
								<i id="desc-module-4" style="font-size: 0"></i><img src="${path}/static/images/temp/S-001_13.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_14.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_15.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_16.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_17.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_18.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_19.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_20.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_21.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_22.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_23.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_24.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_25.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_26.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_27.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_28.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_29.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_30.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_31.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_32.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_33.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_34.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_35.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_36.jpg" alt=""><br>
								
								<i id="desc-module-5" style="font-size: 0"></i><img src="${path}/static/images/temp/S-001_37.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_38.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_39.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_40.jpg" alt=""><br><img src="${path}/static/images/temp/S-001_41.png" width="790" alt="">
							</p>
						</div>
					</div>
					<div role="tabpanel" class="tab-pane fade" id="evaluate" aria-labelledby="evaluate-tab">
						<div class="evaluate-tabs bgf5">
							<ul class="nav-tabs nav-pills clearfix" role="tablist">
								<li role="presentation" class="active"><a href="#all" role="tab" data-toggle="tab" aria-controls="all" aria-expanded="true">全部评价 <span class="badge">${requestScope.evaluations.size()}</span></a></li>
								<li role="presentation"><a href="#good" role="tab" data-toggle="tab" aria-controls="good">好评 <span class="badge">${requestScope.goodEvaluation.size()}</span></a></li>
								<li role="presentation"><a href="#normal" role="tab" data-toggle="tab" aria-controls="normal">中评 <span class="badge">${requestScope.middleEvaluation.size()}</span></a></li>
								<li role="presentation"><a href="#bad" role="tab" data-toggle="tab" aria-controls="bad">差评 <span class="badge">${requestScope.badEvaluation.size()}</span></a></li>
							</ul>
						</div>
						<div class="evaluate-content">
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane fade in active" id="all" aria-labelledby="all-tab">
									<c:forEach items="${requestScope.evaluations}" var="evaluation">
										<div class="eval-box">
											...
											<div class="eval-content">
												...
												<%--<div class="eval-imgs">
													<div class="img-temp"><img src="${path}/static/images/temp/S-001-1_s.jpg" data-src="${path}/static/images/temp/S-001-1_b.jpg" data-action="zoom" class="cover"></div>
													<div class="img-temp"><img src="${path}/static/images/temp/S-001-2_s.jpg" data-src="${path}/static/images/temp/S-001-2_b.jpg" data-action="zoom" class="cover"></div>
													<div class="img-temp"><img src="${path}/static/images/temp/S-001-3_s.jpg" data-src="${path}/static/images/temp/S-001-3_b.jpg" data-action="zoom" class="cover"></div>
													<div class="img-temp"><img src="${path}/static/images/temp/S-001-4_s.jpg" data-src="${path}/static/images/temp/S-001-4_b.jpg" data-action="zoom" class="cover"></div>
													<div class="img-temp"><img src="${path}/static/images/temp/S-001-5_s.jpg" data-src="${path}/static/images/temp/S-001-5_b.jpg" data-action="zoom" class="cover"></div>
												</div>--%>
												<div class="eval-time">
					...
					<div role="tabpanel" class="tab-pane fade" id="evaluate-tab" aria-labelledby="evaluate-tab">
						<div class="descCate-content posr bgf5">
							...
							<div class="picked-box">
								<a class="picked-item" href="">
									<img src="${path}/static/images/temp/S-001-1_s.jpg" class="cover">
									<div class="look_price">¥134.99</div>
								</a>
								<a class="picked-item" href="">
									<img src="${path}/static/images/temp/S-001-2_s.jpg" class="cover">
									<div class="look_price">¥134.99</div>
								</a>
								<a class="picked-item" href="">
									<img src="${path}/static/images/temp/S-001-3_s.jpg" class="cover">
									<div class="look_price">¥134.99</div>
								</a>
								<a class="picked-item" href="">
									<img src="${path}/static/images/temp/S-001-4_s.jpg" class="cover">
									<div class="look_price">¥134.99</div>
								</a>
								<a class="picked-item" href="">
									<img src="${path}/static/images/temp/S-001-5_s.jpg" class="cover">
									<div class="look_price">¥134.99</div>
								</a>
							</div>
						</div>
