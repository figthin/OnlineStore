...
<body>
	...
	<div class="tab-header">
		<div class="inner">
			...
			<div class="pull-right">
				<a href="WEB-INF/views/login.jsp"><span class="cr">登录</span></a>
				<a href="WEB-INF/views/login.jsp?p=register">注册</a>
				<a href="WEB-INF/views/udai_welcome.jsp">我的U袋</a>
				<a href="WEB-INF/views/udai_order.jsp">我的订单</a>
	...
	<div class="top-search">
		<div class="inner">
			<a class="logo" href="WEB-INF/views/index.jsp"><img src="images/icons/logo.jpg" alt="U袋网" class="cover"></a>
			...
			<div class="cart-box">
				<a href="WEB-INF/views/udai_shopcart.jsp" class="cart-but">
	...
	<div class="top-nav bg3">
		<div class="nav-box inner">
			...
			<ul class="nva-list">
				<a href="WEB-INF/views/index.jsp"><li>首页</li></a>
		...
		<section class="item-show__div clearfix">
			<div class="pull-left">
				<div class="item-list__area clearfix">
					<div class="item-card">
						<a href="WEB-INF/views/item_show.jsp" class="photo">
	...
	<div class="right-nav">
		<ul class="r-with-gotop">
			<li class="r-toolbar-item">
				<a href="WEB-INF/views/udai_welcome.jsp" class="r-item-hd">
					<i class="iconfont icon-user" data-badge="0"></i>
					<div class="r-tip__box"><span class="r-tip-text">用户中心</span></div>
				</a>
			</li>
			<li class="r-toolbar-item">
				<a href="WEB-INF/views/udai_shopcart.jsp" class="r-item-hd">
